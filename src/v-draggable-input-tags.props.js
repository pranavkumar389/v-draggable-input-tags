...
export default {
   ...
   * @description Pass an array containing objects like in the example below.
     ...
     properties to a tag object. v-draggable-input-tags won't change the key and value.
   * @property {props}
   * @type {Array}
   * @sync
   * @default []
  ...
  /**
   * @description Property to disable v-draggable-input-tags.
   * @property {props}
   * @type {Boolean}
   * @default false
   */
   ...
   * @description If it's true, the user can paste into the input element and
     v-draggable-input-tags will create tags out of the incoming text.
   * @property {props}
   * @type {Boolean}
   * @default true
   */
